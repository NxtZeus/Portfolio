  ...
  return (
    <section id="skills" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center mx-auto max-w-7xl gap-6 sm:gap-8 lg:gap-12">
          {skillCategories.map((category) => (
            <div 
              key={category.name} 
              className="w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-2rem)] bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100"
            >
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 sm:mb-8 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text ">
                {category.name}
              </h3>
