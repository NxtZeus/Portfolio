    ...
    <section id="experience" className="py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-8">
          {/* Experiencia 1 */}
          <div className="bg-white/80 dark:bg-gray-900/70 rounded-xl shadow-lg p-6 sm:p-8 flex flex-col md:flex-row md:items-center gap-6 border border-gray-100 dark:border-gray-800">
            <div className="flex-shrink-0 flex flex-col items-center md:items-start w-40 mb-4 md:mb-0">
              <span className="text-xs sm:text-sm font-semibold text-gray-500 mb-1">03/2024 - 09/2024</span>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 text-sm sm:text-base space-y-1 pl-2 flex-1">
              <li>Desarrollo y mantenimiento de aplicaciones web con React y Django REST</li>
              <li>Implementación de diseños responsivos y UI/UX optimizado con TailwindCSS y Bootstrap</li>
